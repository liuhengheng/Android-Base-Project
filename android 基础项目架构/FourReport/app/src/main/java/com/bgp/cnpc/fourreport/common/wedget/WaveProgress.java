...
import com.bgp.cnpc.fourreport.common.constant.UiConstant;
import com.bgp.cnpc.fourreport.common.util.MiscUtil;


/**
 * 水波进度条
 * Created by liuheng on 17-5-3.
 */
...
public class WaveProgress  extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mDefaultSize = MiscUtil.dipToPx(context, UiConstant.DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDarkWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_darkWaveAnimTime, UiConstant.DEFAULT_ANIM_TIME);
        mLightWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_lightWaveAnimTime, UiConstant.DEFAULT_ANIM_TIME);
        mMaxValue = typedArray.getFloat(R.styleable.WaveProgress_maxValue, UiConstant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.WaveProgress_value, UiConstant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.WaveProgress_valueSize, UiConstant.DEFAULT_VALUE_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.WaveProgress_hintSize, UiConstant.DEFAULT_HINT_SIZE);

        mCircleWidth = typedArray.getDimension(R.styleable.WaveProgress_circleWidth, UiConstant.DEFAULT_ARC_WIDTH);
        ...
        mWaveHeight = typedArray.getDimension(R.styleable.WaveProgress_waveHeight, UiConstant.DEFAULT_WAVE_HEIGHT);
